...
/// </summary>
public sealed class CreateVenueHandler(EventDbContext db) : IRequestHandler<CreateVenueCommand, Result<Guid>>
{
    /// <summary>
    /// Mekan bilgisini Event schema'sina kaydeder.
    /// CancellationToken EF Core async cagrisina tasinir.
    /// </summary>
    public async ValueTask<Result<Guid>> Handle(CreateVenueCommand request, CancellationToken cancellationToken)
    {
